...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " RONIN" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " RONIN" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " RONIN");
    }
